...
public class ItemPedido {
    ...
    @JsonIgnore // <--- ADICIONADO: evita loop infinito de serialização
    ...
    // Trava de segurança e usa BigDecimal para valores
    @Column(name = "preco_no_momento", nullable = false, precision = 10, scale = 2)
    private BigDecimal precoNoMomento;

    // Status do pedido: pendente / em preparo / cancelado / devolvido / concluído
